...
**Decision versionId:** `84b941a4` (session 16 S2 upgrade engine + proof-promotion gate)  
**HumanApproval versionId:** `0054f20b` (session 15 fallback banner detail — unchanged in session 16)
